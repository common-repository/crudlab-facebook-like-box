...
function wpfblbox_plugin_setup_menu() {
    ...
    if ($myrows[0]->status == 0) {
        add_menu_page('CRUDLAB Facebook Like Box', 'CL FB like box <span id="wpfblbox_circ" class="update-plugins count-1" style="background:#F00"><span class="plugin-count">&nbsp&nbsp</span></span>', 'manage_options', 'wp_facebook-like-box', 'wpfblbox_init', plugins_url("/images/ico.png", __FILE__));
    } else {
        add_menu_page('CRUDLAB Facebook Like Box', 'CL FB like box <span id="wpfblbox_circ" class="update-plugins count-1" style="background:#0F0"><span class="plugin-count">&nbsp&nbsp</span></span>', 'manage_options', 'wp_facebook-like-box', 'wpfblbox_init', plugins_url("/images/ico.png", __FILE__));
    }
}
                        ...
                        <div class="wpfblbox_col wpfblbox_col-adv" style="width:25%;">
                            <div class="wpfblbox_where">
                                ...
                                <div>
                                    ...
                                    <div style="text-align: center;">
                                        <a href="https://wordpress.org/plugins/jazz-popups/" target="_blank" class="wpfblbox_btn wpfblbox_btn-success" style="width:90%; margin-top:5px; margin-bottom: 5px; ">Download</a>
                                    </div>
                                </div>
                                <hr>
                                <div>
                                    ...
                                    <div style="text-align: center;">
                                        <a href="https://wordpress.org/plugins/wp-tweet-plus/" target="_blank" class="wpfblbox_btn wpfblbox_btn-success" style="width:90%; margin-top:5px; margin-bottom: 5px; ">Download</a>
                                    </div>
                                </div>
                            </div>
                            <div class="wpfblbox_where" style="margin-top:15px;">
                                <span>
                                ...
                                <a href="https://www.paypal.com/cgi-bin/webscr?business=billing@purelogics.net&cmd=_xclick" target="_blank">
                                    <img style="width:100%;" src="http://purelogicss-mac-mini.local/wordpress/wp-content/plugins/wp-like-button/images/donate.png">
                                </a>
                            </div>
                        </div>
